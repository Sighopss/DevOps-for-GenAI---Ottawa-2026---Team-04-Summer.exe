...
help:
	...
	@echo "  Drill log + prod approval evidence: docs/DEPLOY_GATE.md (#49)"
	@echo "  Failure demo (ingest down): bash scripts/demo_ingest_down.sh"
	@echo ""
	...
	@echo "  Evidence map + 5xx drill: docs/OBSERVABILITY.md (#50)"
	@echo "  5xx alarm drill: bash scripts/ops_5xx_alarm_drill.sh"
	@echo ""
